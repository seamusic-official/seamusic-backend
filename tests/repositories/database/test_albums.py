...
class TestAlbumRepository:
    ...
    async def test_create_album(self, new_album: CreateAlbumRequestDTO, request: pytest.FixtureRequest) -> None:
        response: CreateAlbumResponseDTO = await self.repository.create_album(album=new_album)
    ...
    async def test_update_album(self, album: UpdateAlbumRequestDTO, request: pytest.FixtureRequest) -> None:
        response: UpdateAlbumResponseDTO = await self.repository.update_album(album=album)
