...
#         return await self.repositories.database.albums.count_albums()
#
...
#             file_stream=file_stream
#         )
#         return await self.repositories.database.albums.update_album(UpdateAlbumRequestDTO(
#             id=album.id,
#             picture_url=file_url,
#             type=Type.album,
#             user_id=user_id,
...
#         )
#
#         return await self.repositories.database.albums.update_album(album=updated_album)
#
