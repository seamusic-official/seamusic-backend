...
Revision ID: ac5f67f2457b
Revises: 
Create Date: 2024-09-04 19:54:02.399261
...
def upgrade() -> None:
    ...
    sa.Column('roles', sa.Enum('artist', 'producer', 'listener', name='role'), nullable=False),
    sa.Column('access_level', sa.Enum('user', 'admin', 'superuser', name='accesslevel'), nullable=False),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('is_available', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
